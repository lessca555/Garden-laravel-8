...
@section('content')
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active">Guests</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Guest Data</h2>
                                                    ...
                                                    @if(count($guests)>0)
                                                        @foreach ($guests as $guest)
                                                            <tr>
                                                                ...
                                                                <td>{{ $guest->email }}</td>
                                                                <td>
                                                                <form action="{{ route('guestAccounts.destroy', $guest->id) }}" method="POST">
                                                                    <a href="{{ route('guestAccounts.edit', $guest->id) }}" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
