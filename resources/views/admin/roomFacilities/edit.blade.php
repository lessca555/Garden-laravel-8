...
@section('title', 'Edit Room Facilities')
...
@section('content')
          ...
          <div class="section-body">
            ...
            <form action="{{ route('roomFacilities.update', $roomFacility->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="facility_name" name="facility_name" value="{{ old('facility_name', $roomFacility->facility_name) }}" autofocus required>
                                </div>
                            </div>
